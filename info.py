...
API_HASH = environ.get('API_HASH', 'b8e16404657a8a382cedb928a3b81e0c')
BOT_TOKEN = environ.get('BOT_TOKEN', '7347402177:AAHh_v9uu70-0qqUQHGmUYuIDFeug3ENxbo')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6910704923').split()]
...
LAZY_GROUP_LOGS = int(environ.get('LAZY_GROUP_LOGS', '-1002209172667'))
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1002061001421'))
PRIME_MEMBERS_LOGS = int(environ.get('PRIME_MEMBERS_LOGS', '-1002190807933'))
